...
worker_processes ENV.fetch('API_INSTANCES', 1).to_i
...
listen ENV.fetch('SOCKET','/tmp/nhshackday.api.sock'), :backlog => ENV.fetch('UNIX_BACKLOG', 1024).to_i
...
pid ENV.fetch('API_PID', '/tmp/nhshackday.api.pid')
